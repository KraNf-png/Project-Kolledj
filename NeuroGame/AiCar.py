...
class Car:
    ...
    def compute_collision_points(self):
        ...
        it = [self.center[0] + math.cos(math.radians(360 - (self.angle + 20))) * lw,
        ...
        self.collision_points = [it, rt, lb, rb]
    ...
    def update(self, road):
        ...
        if self.pos[1] < 20:
            self.pos[1] = 20
        elif self.pos[1] > width - 120:
            self.pos[1] = width - 120
    ...
    while True:
        ...
        for i, car in enumerate(cars):
            if car.is_alive:
                cars_left += 1
                car.update(road)
                genomes[i][1].fitness += car.get_reward()  # new fitness
        ...
        label = heading_font.render("Gens " + str(generation), True, (73, 168, 70))
        label_rect = label.get_rect()
        label_rect.center = (width / 1.5, 300)
        screen.blit(label, label_rect)

        label = font.render("Alive car: " + str(cars_left), True, (51, 59, 70))
        label_rect = label.get_rect()
